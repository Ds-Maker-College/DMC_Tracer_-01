/////////////////////////////////////////////////////
//    Sample soft for DMC_tracer simple complex A 
// 
...
void setup() {
 ...
 //----------------------------------
  ...
  while(1){
    ...
    display.print(F("Ver:Complex Course A"));
...
void loop() {
  ...
  motor_set_L = vel_set_l + (steering1 /20) + (steering2 /15);
  motor_set_R = vel_set_r - (steering1 /20) - (steering2 /15);
