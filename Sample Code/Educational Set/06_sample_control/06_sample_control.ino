/////////////////////////////////////////////////////
//    Sample soft for DMC_tracer sample control 
// 
...
#define LS_L1_MAX 520
#define LS_L1_MIN 60
#define LS_R1_MAX 570
#define LS_R1_MIN 70

#define LS_L2_MAX 390
#define LS_L2_MIN 50
#define LS_R2_MAX 390
#define LS_R2_MIN 50
//-------------------------------------------------------
...
void loop() {
  ...
  line_control = (int)line_sensor_l1 - (int)line_sensor_r1 + 2*((int)line_sensor_l2 - (int)line_sensor_r2);

  motor_set_L = vel_set_l + line_control / 15;
  motor_set_R = vel_set_r - line_control / 15;
